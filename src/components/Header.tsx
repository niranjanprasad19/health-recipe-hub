      ...
      <div className="container mx-auto px-4 py-4">
        <nav className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity group">
            ...
            <span className="text-xl font-bold text-foreground tracking-tight">NutriChef</span>
          </Link>
              ...
              isAuthenticated ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="sm" className="flex items-center gap-2 p-1 pr-2 rounded-xl hover:glass-card">
                ...
                <Link to="/auth">
                  <Button size="sm" className="rounded-xl gradient-primary text-primary-foreground hover:opacity-90 px-5">
                    {t('common.signIn')}
                  </Button>
                </Link>
              )
              ...
              <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                ...
                <SheetContent side="right" className="w-72">
                  <div className="flex flex-col gap-4 mt-8">
                    {isAuthenticated && (
                      <div className="flex items-center gap-3 p-3 glass-card rounded-xl mb-2">
                      ...
                      {!loading && (
                        isAuthenticated ? (
                          ...
                          <Link to="/auth" onClick={() => setMobileMenuOpen(false)}>
                            <Button className="w-full gradient-primary text-primary-foreground">{t('common.signIn')}</Button>
                          </Link>
                        )
                      )}
                    </div>
